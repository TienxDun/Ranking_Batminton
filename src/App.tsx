...
import { Trophy, PlusCircle, History, Users, CalendarRange, Loader2, Sun, Moon } from 'lucide-react';
    ...
    <div className="min-h-screen text-slate-100 pb-24 md:pb-8 font-sans relative overflow-x-hidden transition-colors duration-300">
      ...
      <header className="glass-header sticky top-0 z-10 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          <h1 className="font-bold text-lg sm:text-xl tracking-tight flex items-center gap-3 flex-shrink-0">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5 leading-none">
                <span className="tracking-widest font-black text-sm xs:text-base sm:text-lg logo-text-main">BADMIN</span>
          ...
          <div className="hidden md:flex items-center bg-slate-950/30 border border-white/5 p-1 rounded-xl gap-0.5 shadow-inner">
            <button 
              ...
              className={`px-3.5 py-2 rounded-lg text-xs font-bold transition-all duration-300 flex items-center gap-2 whitespace-nowrap cursor-pointer ${
                activeTab === 'dashboard' 
          ...
          <div className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <button
              onClick={toggleTheme}
              className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-slate-950/40 border border-white/10 flex items-center justify-center shadow-lg hover:border-teal-500/30 text-slate-300 hover:text-teal-400 active:scale-95 transition-all duration-300 cursor-pointer"
