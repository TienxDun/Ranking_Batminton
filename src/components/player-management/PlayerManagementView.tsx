...
export interface PlayerManagementViewModel {
  ...
  groupPanelClass: string;
  groupHeaderClass: string;
  groupBadgeClass: string;
  groupFormClass: string;
  groupInputClass: string;
  groupRowActiveClass: string;
  groupRowInactiveClass: string;
  groupRowInputClass: string;
  playerPanelClass: string;
  playerTitleClass: string;
  playerInputClass: string;
  playerSelectClass: string;
  groupChipClass: string;
  groupChipActiveClass: string;
}
